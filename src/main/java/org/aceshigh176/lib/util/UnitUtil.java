...
public class UnitUtil {
    ...
    private static final double kNanosecondsToMicroseconds = Math.pow(10, -3);
    ...
    private static final float kMetersToInchesFloat = (float) kMetersToInches;
    ...
    public static double engineeringUnitsToCounts(double engineeringUnits, double rotationsPerEngineeringUnit, int countsPerRotation) {
        return engineeringUnits * rotationsPerEngineeringUnit * countsPerRotation;
    }

    public static double engineeringUnitsPerSecondToCountsPer100ms(double engineeringUnits, double rotationsPerEngineeringUnit, int countsPerRotation) {
        return engineeringUnits * rotationsPerEngineeringUnit * countsPerRotation / 10.0;
    }

    public static double countsPer100msToEngineeringUnitsPerSecond(double countsPer100ms, double rotationsPerEngineeringUnit, int countsPerRotation){
        return countsToEngineeringUnits(countsPer100ms, rotationsPerEngineeringUnit, countsPerRotation) * 10.0;
    }

    public static double countsToEngineeringUnits(double counts, double rotationsPerEngineeringUnit, int countsPerRotation) {
        return counts / (countsPerRotation * rotationsPerEngineeringUnit);
    }
...
//        return UnitUtil.rotationsToDistance(UnitUtil.radiansToRotations(Constants.kDriveKv /* V per rad/s */), Constants.kDriveWheelDiameterInches) / 12.0 /* vbus volts */;
    ...
    public static long nanosecondsToMicroseconds(int ns) {
        return (long) (ns * kNanosecondsToMicroseconds);
    }
    ...
    public static float metersToInches(float meters) {
        return meters * kMetersToInchesFloat;
    }
    ...
    public static float inchesToMeters(float inches) {
        return inches / kMetersToInchesFloat;
    }
